...
package eu.javaspecialists.books.dynamicproxies.shortcut.chap2.c_2_3;
...
public class Main {
    public static void main(String[] args) {
        ...
        ((ServiceSecurityProxy) proxy).setCode("Nase");  //Eingabe
        // simulieren
        System.out.println(proxy.work("Hallo"));

        ((ServiceSecurityProxy) proxy).setCode("hoppel"); //Eingabe
        // simulieren
        System.out.println(proxy.work("Hallo"));
    }
}
